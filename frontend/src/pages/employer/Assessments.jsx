      ...
      <div className="container-fluid px-2 px-md-4">
        ...
        <div className="row g-3 mb-4">
          <div className="col-12 col-md-4">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body text-center">
                <h6 className="text-muted">Total Assessments</h6>

                <h2 className="fw-bold text-primary">{assessments.length}</h2>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-md-4">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body text-center">
                <h6 className="text-muted">Active Assessments</h6>
        ...
        <div className="card border-0 shadow-sm d-none d-lg-block">
          <div className="card-header bg-white">
            <h5 className="mb-0">Assessment List</h5>
          </div>
        ...
        <div className="d-lg-none">
          {assessments.map((assessment) => (
            <div key={assessment.id} className="card border-0 shadow-sm mb-3">
              <div className="card-body">
                <h5 className="fw-bold">{assessment.title}</h5>
                ...
                <p className="mb-1">
                  <strong>Candidates:</strong> {assessment.candidates}
                </p>

                <p className="mb-1">
                  <strong>Created:</strong> {assessment.createdOn}
                </p>
            ...
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className="modal-content border-0 shadow">
                <div className="modal-header">
                  <h5 className="modal-title fw-bold">Edit Assessment</h5>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        defaultValue={selectedAssessment?.duration}
                      />
                    </div>
